...
{
	public static var psychEngineVersion:String = '0.2.0a'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "Sun Engine v" + psychEngineVersion, 12);
